...
// So, this script creates a ANN object from the libraries mentioned above, then it trains it with some data and predicts a steering value to turn the car with, to avoid obstacles.
...
public class NeuralBrain : MonoBehaviour
{
	...
	private string readPath = "Assets/CAS_trainingData/TrainingData.txt"; // change this according to your system. Just ensure unity can get access to the TrainingData.txt file
